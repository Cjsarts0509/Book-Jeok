...
const App = (() => {
  ...
  function force2faSetup() {
    root().innerHTML = `<div class="login-screen"><div class="login-card" style="max-width:460px">
      <img src="assets/logo.svg?v=52" class="login-logo" alt="북적북적">
    ...
    root().innerHTML = `
      <div class="layout">
        <header class="appbar">
          ...
          <div class="brand" id="brand-home" title="홈으로"><img src="assets/logo.svg?v=52"><span class="brand-name">북적북적</span></div>
