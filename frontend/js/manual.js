  ...
  const adminSections = `
    ...
    <section class="manual-sec">
      ...
      <ul>
        ...
        <li><b>용량(트리맵)</b> — <span class="kbd">📊 용량</span> 탭은 <b>SpaceSniffer식 트리맵</b>입니다. 타일 크기 = 사용량, 색상 = 할당률(파랑→빨강). <b>계정 타일을 클릭하면 폴더별</b>로 열리고, 상단 <b>← 전체 계정</b>으로 돌아갑니다. 마우스를 올리면 상세가 뜹니다.</li>
