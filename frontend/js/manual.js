  ...
  const userSections = `
    <section class="manual-sec">
      ...
      <ul>
        ...
        <li><b>내 설정</b> — 상단 <span class="kbd">⚙️ 설정</span>에서 <b>알림 이메일</b>, <b>이메일 수신 여부</b>, <b>같은 이름 업로드 처리(번호/덮어쓰기)</b>, <b>비밀번호 변경</b>을 합니다.</li>
    ...
    <section class="manual-sec">
      ...
      <ul>
        ...
        <li><b>활동 알림(공유별)</b> — 공유·업로드요청을 만들 때 <b>🔔 인앱 알림</b>·<b>✉️ 이메일 알림</b>을 각각 켤 수 있습니다. 켜면 <b>다운로드·업로드가 발생할 때</b> 만든 사람에게 알림이 갑니다(이메일은 <span class="kbd">⚙️ 설정</span>의 주소로). 상단 <span class="kbd">🔔 알림</span>에서 안읽음 개수·목록을 봅니다.</li>
      </ul>
    </section>
